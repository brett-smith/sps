...
public class SignConfig {
	...
	public void signDigest(File appdir) throws IOException, GeneralSecurityException {
		sign(new File(appdir, "digest.txt"), new File(appdir, "digest.txt" + SIGNATURE_SUFFIX));
		sign(new File(appdir, "digest2.txt"), new File(appdir, "digest2.txt" + SIGNATURE_SUFFIX));
	}
	...
	private void sign(File inputFile, File signatureFile)
		...
		String signed = new String(java.util.Base64.getEncoder().encodeToString(sig.sign()));
